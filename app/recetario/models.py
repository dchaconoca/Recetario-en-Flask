...
class Ingrediente(db.Model):
    ...
    def listar(self):
        return self.query.order_by(Ingrediente.nombre).all()
...
class Receta(db.Model):
    ...
    def listar(self):
        return self.query.order_by(Receta.titulo).all()

    # Devuelve la lista de todas las recetas de una categoria
    def listarPorCategoria(self, categoria_id):
        return self.query.filter_by(categoria_id=categoria_id).order_by(Receta.titulo).all()
...
class IngredienteReceta(db.Model):
    ...
    def ingredientesReceta(self, rec_id):
        return self.query.filter_by(ingrediente_id=rec_id).order_by(Ingrediente.nombre).all()
